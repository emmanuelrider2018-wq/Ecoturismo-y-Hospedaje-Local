...
# Tu webhook de Discord directo para las alertas
...
# Base de datos local con los 20 hoteles estructurados con todo su diseño original
HOTELES = [
    {
        "id": 1, 
    ...
    },
    {
        ...
        "direccion": "Paraje Las Encinass S/N, Alta Montaña",
...
@app.route('/')
def index():
    # Inyectamos el bot de Discord al cargar la página sin arruinar la vista original
    enviar_notificacion_discord("¡Alguien acaba de entrar a la página de Ecoturismo de Tlalpujahua! 🌲")
